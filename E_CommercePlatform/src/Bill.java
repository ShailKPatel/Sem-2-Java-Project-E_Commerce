...
public class Bill {
	static Connection con = Shop.con;
	private int bill_id;
	...
	Bill(String cname, String badd, String cphn, ArrayList<Integer> p_id, ArrayList<String> p_name,
			ArrayList<Integer> quant, ArrayList<Float> prc) throws IOException {
		cust_name = cname;
		bill_addr = badd;
		cust_phone = cphn;
		total_amount = 0.0f;
